 ...
 * @Description:
 * @Autor: weipengfei
 * @Date: 2021-09-01 17:20:57
 * @LastEditors: weipengfei
 * @LastEditTime: 2021-09-09 11:30:00
 */
    ...
    const legacyGenerateBundlePlugin = {
        ...
        async generateBundle(opts, bundle) {
            if (!isLegacyBundle(bundle, opts)) {
                ...
                isDebug &&
                    console.log(`[@vitejs/plugin-legacy] modern polyfills:`, modernPolyfills);
            ...
            if (legacyPolyfills.size || genDynamicFallback) {
                ...
                isDebug &&
                    console.log(`[@vitejs/plugin-legacy] legacy polyfills:`, legacyPolyfills);
 ...
 */
async function buildPolyfillChunk(name, imports, bundle, facadeToChunkMap, buildOptions) {
...
function isLegacyChunk(chunk, options) {
    ...
    return options.format === "iife" && chunk.fileName.includes("-legacy");
}
